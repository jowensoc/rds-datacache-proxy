...
case class InterestAccruals(interestAccruals: List[InterestAccrual])

object InterestAccruals {
  implicit val format: OFormat[InterestAccruals] = Json.format[InterestAccruals]
}
